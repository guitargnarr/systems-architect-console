...
// Trust stats
const trustStats = [
  { value: '5,500+', label: 'Newsletter Subscribers' },
    ...
    <section className="bg-white py-8 border-b border-primary-100">
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          {/* Trustpilot Badge */}
          <motion.a
            href="https://www.trustpilot.com/review/ibanista.com"
            target="_blank"
            rel="noopener noreferrer"
            variants={scaleIn}
            className="flex items-center gap-2 bg-[#00b67a] text-white px-4 py-2 rounded-lg hover:bg-[#00a06a] transition-colors"
          >
            ...
            <div className="border-l border-white/30 pl-2 ml-1">
              ...
              <div className="text-[10px] opacity-80">Trustpilot</div>
            </div>
          </motion.a>
        </motion.div>
      </div>
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="fixed bottom-6 right-6 z-50 bg-accent-500 hover:bg-accent-600 text-white font-semibold px-6 py-4 rounded-full shadow-xl flex items-center gap-2 transition-colors"
        >
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="border-t border-primary-800 pt-8 mb-6">
            <div className="flex justify-center gap-4">
              <a href="https://www.instagram.com/ibanista/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-800 hover:bg-primary-700 rounded-full flex items-center justify-center transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/ibanistafr/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-800 hover:bg-primary-700 rounded-full flex items-center justify-center transition-colors" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.youtube.com/@ibanista" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-800 hover:bg-primary-700 rounded-full flex items-center justify-center transition-colors" aria-label="YouTube">
                <Youtube className="w-5 h-5" />
              </a>
              <a href="https://open.spotify.com/show/ibanista" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-800 hover:bg-primary-700 rounded-full flex items-center justify-center transition-colors" aria-label="Spotify Podcast">
                <Music className="w-5 h-5" />
              </a>
              <a href="https://www.linkedin.com/company/ibanista/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-800 hover:bg-primary-700 rounded-full flex items-center justify-center transition-colors" aria-label="LinkedIn">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-wrap items-center gap-4 text-xs">
              ...
              <span className="flex items-center gap-1">
                <Award className="w-3 h-3" /> B-Corp Certified
              </span>
